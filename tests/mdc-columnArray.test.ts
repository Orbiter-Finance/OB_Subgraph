...
describe('Describe ColumnArrayUpdated assertions', () => {
  ...
  const MDCBindDealerId =
    '0xa16081f360e3847006db660bae1c6d1b2e17ec2a-1' as string;
  ...
  beforeAll(() => {
    ...
    let ebcsRemove = [
      Address.fromString(ebcRemoved1),
      Address.fromString(ebcRemoved2),
    ];
    let chainIds = [
      BigInt.fromI32(123),
      BigInt.fromI32(456),
    ...
    let ebcs = [
      Address.fromString(ebc0),
      Address.fromString(ebc1),
      Address.fromString(ebc2),
    ];
    ...
    const newColumnArrayUpdatedEvent0 = createColumnArrayUpdatedEvent(
      ...
      [dealersAddrRemove1, dealersAddrRemove2, dealersAddrRemove1],
      ebcsRemove,
      [],
    );
  ...
  test('columnArraySnapshot created and stored', () => {
  ...
  test('Dealer created and stored', () => {
    ...
    assert.fieldEquals('Dealer', dealerRemoved1.toLowerCase(), 'mdcs', '[]');

    assert.fieldEquals('Dealer', dealerRemoved2.toLowerCase(), 'mdcs', '[]');
  ...
  test('ebcRel created and stored', () => {
    ...
    assert.fieldEquals('ebcRel', ebc0.toLowerCase(), 'id', ebc0.toLowerCase());

    assert.fieldEquals('ebcRel', ebc1.toLowerCase(), 'id', ebc1.toLowerCase());
    ...
    // check remove ebc
    assert.fieldEquals('ebcRel', ebcRemoved1.toLowerCase(), 'mdcList', '[]');

    assert.fieldEquals('ebcRel', ebcRemoved2.toLowerCase(), 'mdcList', '[]');
