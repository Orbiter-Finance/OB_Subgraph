  ...
  beforeAll(() => {
    ...
    let spv: Array<ethereum.Value> = [
      ethereum.Value.fromAddress(
        Address.fromString('0x20a01b78e7100a16ce9171730e1f2eb081a6fbfb'),
      ),
    ];
    ...
    const newChainInfoUpdatedEvent = createChainInfoUpdatedEvent(id, chainInfo);
...
describe('Describe check ChainTokenUpdated Event', () => {
  ...
  const Chainid = '985';
  const mockHashId =
    '0x716e6e66ab7e998b8e09f369421529d0cf5e90a6d9409808e3374746804fb52b'; // hash("985-0x2265d16498efe5e63e08fa50f4344a2668db90ad")
  beforeAll(() => {
  ...
  test('tokenRel created and stored', () => {
    ...
    assert.fieldEquals('tokenRel', mockHashId, 'id', mockHashId);
    ...
    assert.fieldEquals('chainRel', Chainid, 'tokens', `[${mockHashId}]`);
